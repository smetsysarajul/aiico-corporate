...
?>              <fieldset><legend><?php echo BFText::_('COM_BREEZINGFORMS_TAGS_AND_CONTENT'); ?></legend>
		                <?php echo bf_alert('Joomla! tagging is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html', true);?>
                </fieldset>
<?php
...
?>
                 <fieldset><legend>Salesforce®</legend>
	                 <?php echo bf_alert('Salesforce® is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html', true);?>
                     </fieldset>
<?php
                $tabs->endTab();
...
?>
                <fieldset><?php echo bf_alert('Dropbox® is supported in the full version only', 'https://crosstec.org/en/extensions/joomla-forms-download.html', true);?>
                </fieldset>
<?php
