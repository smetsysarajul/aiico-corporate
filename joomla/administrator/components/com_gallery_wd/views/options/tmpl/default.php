...
$document->addScript(JURI::root() . 'components/com_gallery_wd/js/jscolor/jscolor.js');	
    ...
    <div style="font-size: 14px; font-weight: bold;">
      ...
      <a style="color: blue; text-decoration: none;" target="_blank" href="https://web-dorado.com/joomla-gallery-guide-step-5/5-1.html">Read More in User Manual</a>
    </div>
...
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
              ...
              <tr id="tr_popup_fullsize_image">
                ...
                <td>
                  <input disabled="disabled" type="radio" name="popup_enable_fullsize_image" id="popup_enable_fullsize_image_1" value="1" <?php if ($row->popup_enable_fullsize_image) echo 'checked="checked"'; ?> /><label for="popup_enable_fullsize_image_1">Yes</label>
                  <input disabled="disabled" type="radio" name="popup_enable_fullsize_image" id="popup_enable_fullsize_image_0" value="0" <?php if (!$row->popup_enable_fullsize_image) echo 'checked="checked"'; ?> /><label for="popup_enable_fullsize_image_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
              <tr id="tr_popup_download">
                ...
                <td>
                  <input disabled="disabled" type="radio" name="popup_enable_download" id="popup_enable_download_1" value="1" <?php if ($row->popup_enable_download) echo 'checked="checked"'; ?> /><label for="popup_enable_download_1">Yes</label>
                  <input disabled="disabled" type="radio" name="popup_enable_download" id="popup_enable_download_0" value="0" <?php if (!$row->popup_enable_download) echo 'checked="checked"'; ?> /><label for="popup_enable_download_0">No</label>
<div class="spider_description spider_free_version">This option is disabled in free version.</div>
                </td>
              </tr>
