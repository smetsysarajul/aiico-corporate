...
$document->addScript(JURI::root() . 'components/com_gallery_wd/js/jscolor/jscolor.js');	
    ...
    $current_type = JRequest::getVar('current_type','Thumbnail');
    $border_styles = array(
      'none' => 'None',
      'solid' => 'Solid',
      'dotted' => 'Dotted',
    ...
    <form class="wrap" method="post" id="adminForm" name="adminForm" action="index.php?option=com_gallery_wd&view=themes" style="width:99%;">
