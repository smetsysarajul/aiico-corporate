var boardData = [{
  ...
  },
  {
    ...
    bio: "An alumnus of the prestigious Harvard Business School, Lagos Business School and University of Lagos, Ademola Adebise is an Executive Director at Wema Bank. Prior to joining Wema Bank Plc, he worked at Accenture, the global consulting firm, National Bank of Nigeria and Chartered Bank in various capacities spanning over 26 years.",
    education: "Ademola Adebise is a graduate of Computer Science. He also holds an MBA from Pan African University, Lagos Business School. A thorough-bred, resourceful and self-motivated personality, Ademola is a Fellow of the Institute of Chartered Accountants of Nigeria as well as an Associate of the Chartered Institute of Taxation & Computer Professionals (Registration Council of Nigeria).    Ademola also serves on the Boards of AIICO Pension Funds Administrator and the Financial Institution Training Centre (FITC)."
  },
  {
    id: "board-6",
    name: "S.D.A Sobanjo",
    ...
    bio: "Mr. S.D.A. Sobanjo was until recently the MD/CEO of AIICO Insurance Plc (2006-2013). He is a serving member of the Board of Directors at AIICO Insurance Plc.  He is a Chartered Insurer, a fellow of the Chartered Insurance Institute of London and Nigeria and serves as Member of Nigeria Institute of Management. He has been holding Management Positions for over 15 years. He served as Managing Director in Highgate Insurance Brokers Ltd (1993 – 2000) from where he moved to AIICO Insurance Plc, Lagos as Deputy General Manager for Life Operations. In January 2005, he was appointed Managing Director in African Alliance Insurance Co. Ltd, a position he held until his appointment as Managing Director at AIICO Insurance Plc.  He has varied experience spanning Pension Administration, Life Operations, General Insurance Administration, Product Development, Marketing and information Technology.",
  ...
  },
  {
    ...
    bio: "Samaila is the Vice Chairman of Africapital-Gem Development Partners Limited, a project development firm focused on providing pragmatic infrastructure solutions to the significantly underserved Nigerian market. He is also a Director of West Africa Infrastructure Investment Managers – JV with Old Mutual to raise and manage the Nigerian Infrastructure Investment Fund. Over the last 26 years, Samaila has worked in various capacities—he was Chief Financial Officer at Dangote Cement Plc, as well as CFO for Obajana Cement Plc. At Obajana he was a key member of the team that spearheaded the development of Africa’s largest green-field cement project. Prior to that, he was the Treasurer for the Dangote Group during its transformation from a trading company to an industrial conglomerate. Samaila also spent time at Liberty Bank Plc. where he was the Head of Investment Banking and subsequently Group Head of Risk Management. Prior to his post at Liberty Bank, he was the Head of Project Finance at FSB Bank (Fidelity Bank). ",
    education: "Samaila is a Fellow of the Institute of Chartered Accountants of Nigeria and the Eisenhower Fellowships International Leader Exchange Philadelphia USA. He also holds a B.Sc Hons. Accounting from Ahmadu Bello University, Zaria."
  },
  {
    id: "board-8",
    ...
    bio: "Folakemi Fajemirokun commenced her work experience as Risk Intern at the AFRISK Management Consultants Ltd, Lagos Nigeria during her service year in 2011. She was instrumental in the development of a risk management framework checklist with 50+ controls to aid Insurance companies in assessing against industry standards.   In September 2012, she joined DELOITTE LLP, London England as a Manager, Risk Advisory. During this period, she developed Business Continuity Plan, Process Mapping, was engaged in Risk Management Frameworks reviews for several companies and also advised on risk management frameworks to be adopted. She was recently appointed as a Non-Executive Director on the Board of AIICO Insurance Plc.",
    education: "Folakemi Fajemirokun obtained her first degree in Economics (BSc. Economics) at the University College London (UCL). She obtained her Master’s degree (MSc. Decision Sciences in 2011 at the London School of Economics & Political Science (LSE). In 2014, she was awarded A Diploma in Management Accounting at the Chartered Institute of Management Accountants (CIMA). In same year, she obtained a certification in Risk Management (Financial Services) at the Institute of Risk Management (IRM)."
  }
];
...
var managementData = [{
  ...
  },
  {
    ...
    bio: "Olusanjo Shodimu started his career in 2003 as a technical sales lead with a local software company in Lagos, before joining Broad Bank Nigeria Limited (now part of Union Bank) as a Technology Analyst – where he was responsible for network operations and service delivery. Prior to joining AIICO Insurance Plc, he worked with Accenture – a global management consulting and technology company for 10 years (2004 – 2014) where he led the delivery of various strategy and business transformation projects for major banking and insurance clients in Nigeria and across the West African region. Olusanjo joined AIICO in June, 2014 as Chief Information Officer with responsibility for providing strategic leadership for the development and implementation of information technology initiatives to deliver on the strategic mandates and objectives of AIICO. In 2019, he was appointed Divisional Head, Shared Services which encompasses Technology & Operations, Customer Service, Strategic Marketing & Communication, Strategy & Corporate Planning and Estate Management – with responsibility for aggregating group synergies for cost optimization and returns on investment.",
