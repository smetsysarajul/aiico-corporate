<?php 
$page ='about';
$pageTitle = "About Us | AIICO Insurance Plc.";
 ?>
      ...
      <div class="row align-items-center justify-content-between">
        <div class="col-md-5">
          ...
          <ol class="numbered-list">
            ...
            <li class="numbered-list__item">Pension management</li>
            <li class="numbered-list__item">Health insurance and</li>
            <li class="numbered-list__item">Asset management</li>
          </ol>
        </div>
        <div class="col-md-6">
