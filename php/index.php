...
<main>
            ...
            <div class="container">
              <div class="row">
                <div class="col-md-5">
                  ...
                  <p class="paragraph">
                    When your responsibility is creating and protecting wealth for a diverse clientele like ours is, you can never stop looking
                    for the best and the brightest experience.
                  </p>
        ...
        <div class="carousel-item">
          <div class="carousel-info">
            <div class="container">
              <div class="row">
                <div class="col-md-5">
                  <h1 class="heading heading--primary">2. The 49th Annual General Meeting of AIICO Insurance Plc</h3>

                    <p class="paragraph">
                      Welcome to a new world of Insurance. It will no longer be complex, time consuming or impersonal. We are changing our customer
                      service culture, the treatment of claims and range of products, to protect you, your family & your
                      business.
                    </p>
                    <div class="carousel-ctas">
                      <a href="#" class="btn btn--primary">Find out more -></a>
        ...
        <div class="carousel-item">
          <div class="carousel-info">
            <div class="container">
              <div class="row">
                <div class="col-md-5">
                  <h1 class="heading heading--primary">3. The Nigeria Stock Exchangewishes AIICO well</h3>
                    <p class="paragraph">
                      Welcome to a new world of Insurance. It will no longer be complex, time consuming or impersonal. We are changing our customer
                      service culture, the treatment of claims and range of products, to protect you, your family & your
                      business.
        ...
        <div class="carousel-item">
          <div class="carousel-info">
            <div class="container">
              <div class="row">
                <div class="col-md-5">
                  <h1 class="heading heading--primary">4. AIICO IN Strategic Partnership with Wema Bank</h3>
                    <p class="paragraph">
                      Welcome to a new world of Insurance. It will no longer be complex, time consuming or impersonal. We are changing our customer
                      service culture, the treatment of claims and range of products, to protect you, your family & your
                      business.
  ...
  <section class="section section__about">
    <div class="container">
      <div class="section__intro">
        ...
        <p class="section__sub-heading">Welcome to a new world of Insurance. It will no longer be complex, time consuming or impersonal. We are changing
          our customer service culture, the treatment of claims and range of products, to protect you, your family & your
          business.
        </p>
  ...
  <section class="section section__products">
    <div class="container">
      <div class="section__intro">
        ...
        <p class="section__sub-heading">We offer a wide range of products and services which are tailored towards our customers' needs.We offer a wide
          range of products and services which are tailored.</p>
      </div>
        ...
        <ul class="nav nav-fill" id="myTab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="individual-tab" data-toggle="tab" href="#individual" role="tab" aria-controls="individual"
              aria-selected="true">Individual plans</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="business-tab" data-toggle="tab" href="#business" role="tab" aria-controls="business" aria-selected="false">Business plans</a>
          </li>
        </ul>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-md-5">
          ...
          <p class="paragraph">We offer a wide range of products and services which are tailored towards our customers' needs.</p>
          <ul class="big-list">
            <li class="big-list__item">Full suite of insurance products
              <p class="paragraph">We offer a wide range of products and services which are tailored towards our customers' needs.</p>
            </li>
            <li class="big-list__item">Top 5 non-life insurance companies
              <p class="paragraph">We offer a wide range of products and services which are tailored towards our customers' needs.</p>
            </li>
            <li class="big-list__item">Only brand you need to trust
              <p class="paragraph">We offer a wide range of products and services which are tailored towards our customers' needs.</p>
            </li>
          </ul>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-md-5">
          ...
          <div class="paragraph">
            We offer a wide range of products and services which are tailored towards our customers' needs.We offer a wide range of products
            and services which are tailored.
          </div>
          <ul class="check-list">
  ...
  <section class="section section__numbers">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-2 text-center mb-2 px-2">
    ...
    <a href="#" class="btn btn--link white mt-3">View financial reports &raquo;</a>
  </section>
  ...
  <section class="section section__clients">
    <div class="container">
      <div class="section__intro">
        ...
        <p class="section__sub-heading">Whether you need a place to meet your clients or teammates, a late-night hack spot, or just some heads down.</p>
      </div>
      ...
      <div class="row">
          ...
          <div class="col-md-6">
              <div class="news">
                  ...
                  <p class="paragraph news__excerpt">For confirmation of payments (cash & cheques) made directly to AIICO's bank accounts, cashiers confirm the payment and updates customer's policy(ies), receipt is sent via email to the customer/agent.</p>
                  <a href="single-news.html" class="news__cta">
                      Read more &raquo;
                  </a>
              </div>
