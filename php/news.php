              ...
              <div class="news">
                ...
                <div class="news__body">
                  ...
                  <p class="paragraph news__excerpt">
                    ...
                    retail distribution network. This is following the recent endorsement by both The National Insurance
                    Commission (NAICOM) and The Central Bank of Nigeria (CBN).
                  </p>
                  <a href="single-news.php" class="news__cta">
                    Read more &raquo;
                  </a>
            ...
            <div class="col-md-4 mb-5">
              <div class="news">
                ...
                <div class="news__body">
                  ...
                  <p class="paragraph news__excerpt">
                    With an average contribution of 24%, agriculture has remained a significant contributor to Nigeria’s
                    GDP. Being the provider of employment for over 60% of the population, agriculture is pivotal to
                    economic development, and more of the efforts to revive the economy, and reduce significantly the
                    level of poverty, should be devoted to energizing the agricultural sector.
                  </p>
                  <a href="single-news.php" class="news__cta">
                    Read more &raquo;
                  </a>
